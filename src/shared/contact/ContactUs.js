            ...
            <div className="max-w-[570px] mb-12 lg:mb-0">
               ...
               <div className="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div className="w-full">
                     <h4 className="font-bold text-dark text-xl mb-1 font-Gelasio">Location</h4>
                     <p className="text-base text-body-color font-Inter">
                       Viraj Khand-2 Gomti Nagar Lucknow , India
                     </p>
                  </div>
               </div>
               <div className="flex mb-8 max-w-[370px] w-full" >
                  ...
                  <div className="w-full">
                     <h4 className="font-bold text-dark text-xl mb-1 font-Gelasio">Phone Number</h4>
                     <p className="text-base text-body-color font-Inter">7985503761</p>
                  </div>
               </div>
               <div className="flex mb-8 max-w-[370px] w-full">
                  <div
