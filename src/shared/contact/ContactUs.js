...
const ContactUs = () => {
  return (
    <div className='py-10'>
        <h1 className='text-center xl:text-[40px] text-3xl font-bold'>Contact</h1>
      ...
      <div class="flex flex-wrap lg:justify-between -mx-4">
         <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div class="max-w-[570px] mb-12 lg:mb-0">
               ...
               <p class="text-base text-body-color leading-relaxed mb-9 w-[450px]">
               ...
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     ...
                     <p class="text-base text-body-color">7985503761</p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div class="w-full">
                     ...
                     <p class="text-base text-body-color">niteshshukla1696@gmail.com</p>
                  </div>
               </div>
            </div>
         </div>
