      ...
      {showfirstModal ? (
        <>
          ...
          >
            ...
            <div className="relative w-auto my-6 mx-2 max-w-full">
              <div className="border-0  shadow-lg relative flex flex-col xl:w-[500px] md:w-[400px] w-full overflow-y-scroll bg-white outline-none focus:outline-none">
